...
import { fetchBusinessMetrics, fetchTransactionData, fetchUserAnalytics } from '../../store/slices/analyticsSlice';
    ...
    <div className="min-h-screen bg-background p-8 transition-colors duration-200">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-3xl font-bold text-text tracking-tight">Dashboard Overview ( to be producer )</h2>
